...
export const atrivialGrammar = class ES3Grammar extends (_functionMixin = functionMixin(
  ...
  static {
    [_initProto] = _applyDecs(
      this,
      [
        [[AllowEmpty, Node], 2, 'Program'],
        [_ParenthesisExpressionDecs, 2, 'ParenthesisExpression'],
        [_IdentifierDecs, 2, 'Identifier'],
        [_ListDecs, 2, 'List'],
        [Node, 2, 'Keyword'],
        [_LiteralDecs, 2, 'Literal'],
        [_PunctuatorDecs, 2, 'Punctuator'],
        [_AnyDecs, 2, 'Any'],
        [_AllDecs, 2, 'All'],
        [_OptionalDecs, 2, 'Optional'],
      ],
      [],
      0,
      void 0,
  ...
  *[((_ParenthesisExpressionDecs = [CoveredBy('Expression'), Node]),
  (_IdentifierDecs = [CoveredBy('Expression'), Node]),
  (_ListDecs = [AllowEmpty, InjectFrom(productions)]),
  (_LiteralDecs = [Node, InjectFrom(productions)]),
  (_PunctuatorDecs = [Node, InjectFrom(productions)]),
  (_AnyDecs = InjectFrom(productions)),
  (_AllDecs = InjectFrom(productions)),
  (_OptionalDecs = [AllowEmpty, InjectFrom(productions)]),
