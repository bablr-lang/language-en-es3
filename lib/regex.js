 ...
 * @generatedfrom ./regex.macro.js#5dc3fb2b21f8afc18c1407f53bcdfeaa1d03b570
...
export const grammar = stateEnhancer(
  ...
  class RegexGrammar {
    static {
      [_initProto] = _applyDecs(
        ...
        [
          ...
          [_GroupDecs, 2, 'Group'],
          [Node, 2, 'Backreference'],
          [_LookaheadDecs, 2, 'Lookahead'],
          ...
          [_EscapeSequenceDecs, 2, 'EscapeSequence'],
          [Node, 2, 'EscapeCode'],
          [Node, 2, 'Digit'],
          [_AnyDecs, 2, 'Any'],
    ...
    *[((_FlagsDecs = [Attributes(Object.keys(flagCharacters)), AllowEmpty, Node]),
    (_GroupDecs = [CoveredBy('Element'), Node]),
    (_LookaheadDecs = [Attributes(['negate']), Node]),
    ...
    (_WordBoundaryAssertionDecs = [Attributes(['negate']), CoveredBy('Assertion'), Node]),
    (_CharacterDecs = [CoveredBy('Element'), CoveredBy('CharacterClassElement'), Node]),
    (_CharacterClassDecs = [CoveredBy('Element'), Node]),
    ...
    (_DigitCharacterSetDecs = [Attributes(['negate']), CoveredBy('CharacterSet'), Node]),
    (_SpaceCharacterSetDecs = [Attributes(['negate']), CoveredBy('CharacterSet'), Node]),
    (_WordCharacterSetDecs = [Attributes(['negate']), CoveredBy('CharacterSet'), Node]),
    (_QuantifierDecs = [Attributes(['min', 'max']), Node]),
    (_EscapeSequenceDecs = [Attributes(['cooked']), Node]),
