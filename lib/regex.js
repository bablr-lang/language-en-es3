 ...
 * @generatedfrom ./regex.macro.js#b1b3aa937bb1e2a2b8e637609ad6c6056895eb24
...
import { eat, eatMatch, match, shiftMatch, guard, defineAttribute, fail } from '@bablr/helpers/grammar';
...
export const grammar = class RegexGrammar {
  ...
  *Element() {
    ...
    yield eat(m`<__Any />`, [m`<CharacterClass '[' />`, m`<Group '(?:' />`, m`<CapturingGroup '(' />`, m`<__Assertion /[$^]|\\b/i />`, m`<CharacterSet /\.|\\[dswp]/i />`, m`<Character />`]);
    if (yield match(re`/[*+?{]/`)) {
