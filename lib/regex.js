 ...
 * @generatedfrom ./regex.macro.js#123e0b58e84a6b48ad01d49a8d4bd9f5d0eeb64d
...
export const grammar = class RegexGrammar {
  ...
  *Element() {
    ...
    yield eat(m`<_Any />`, [m`<CharacterClass '[' />`, m`<Group '(?:' />`, m`<CapturingGroup '(' />`, m`<__Assertion /[$^]|\\b/i />`, m`<CharacterSet /\.|\\[dswp]/i />`, m`<Character />`]);
    if (yield match(re`/[*+?{]/`)) {
