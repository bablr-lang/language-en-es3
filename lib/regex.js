 ...
 * @generatedfrom ./regex.macro.js#61c2dee3eb2896d9fc06e4470972d01000b0e214
...
export const grammar = class RegexGrammar {
  ...
  *Element() {
    ...
    yield eat(m`<__Any />`, [m`<CharacterClass '[' />`, m`<Group '(?:' />`, m`<Assertion /[$^]|\\b/i />`, m`<CharacterSet /\.|\\[dswp]/i />`, m`<Character />`]);
    if (yield match(re`/[*+?{]/`)) {
