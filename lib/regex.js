...
import { buildCharacterClass, buildQuantifier, buildString } from '@bablr/helpers/builders';
...
const escapables = deepFreezeRecord({
  f: '\f',
  n: '\n',
  r: '\r',
  t: '\t',
...
const flagCharacters = deepFreezeRecord({
  global: 'g',
  ignoreCase: 'i',
  multiline: 'm',
});
...
export default class Regex {
  ...
  static context = deepFreezeRecord({ flagCharacters });
  ...
  *Flags() {
    ...
    flagsPattern ||= m`/${printSource(
      buildCharacterClass([false, ...Object.values(flagCharacters)]),
    )}+/`;
