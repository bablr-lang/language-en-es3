 ...
 * @generatedfrom ./regex.macro.js#019feddee0c3310037788ac0f1618746a252aee4
...
export const grammar = class RegexGrammar {
  ...
  *Element() {
    ...
    yield eat(m`<Any />`, [m`<CharacterClass '[' />`, m`<Group '(?:' />`, m`<Assertion /[$^]|\\b/i />`, m`<CharacterSet /\.|\\[dswp]/i />`, m`<Character />`]);
    if (yield match(re`/[*+?{]/`)) {
