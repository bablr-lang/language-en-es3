 ...
 * @generatedfrom ./statement.macro.js#8b5fc9a709c029a2ea4764e3a4de1a925fe50efb
...
export const mixin = Base => {
  let _initProto, _ExpressionStatementDecs, _FunctionStatementDecs, _ReturnStatementDecs, _ThrowStatementDecs, _DebuggerStatementDecs, _VariableDeclarationStatementDecs, _EmptyStatementDecs, _BlockStatementDecs, _IfStatementDecs, _WhileStatementDecs, _DoWhileStatementDecs, _SwitchStatementDecs, _ForStatementDecs, _LabeledStatementDecs, _BreakStatementDecs, _ContinueStatementDecs, _PunctuatorDecs;
  return class ES3StatementGrammar extends Base {
    ...
    *Statement({
      ...
      yield eat(m`<__Any />`, [[m`<EmptyStatement /;/ />`, o({
        allowEmpty
      })], m`<BlockStatement '{' />`, m`<IfStatement 'if' />`, m`<WhileStatement 'while' />`, m`<DoWhileStatement 'do' />`, m`<SwitchStatement 'switch' />`, m`<ForStatement 'for' />`, m`<FunctionStatement /function [a-zA-Z$_]/ />`, m`<ReturnStatement 'return' />`, m`<ThrowStatement 'throw' />`, m`<DebuggerStatement 'debugger' />`, m`<VariableDeclarationStatement 'var' />`, m`<ExpressionStatement />`]);
    }
    *EmptyStatement({
      props: {
        allowEmpty = true
