 ...
 * @generatedfrom ./statement.macro.js#70693c65b54a5abb876853b0756947f640c311d2
  ...
  return class ES3StatementGrammar extends Base {
    ...
    *Statement({
      ...
      yield eat(m`<__Any />`, [[m`<EmptyStatement /;/ />`, o({
        allowEmpty
      })], m`<BlockStatement '{' />`, m`<IfStatement 'if' />`, m`<WhileStatement 'while' />`, m`<DoWhileStatement 'do' />`, m`<SwitchStatement 'switch' />`, m`<ForStatement 'for' />`, m`<FunctionStatement /function [a-zA-Z$_]/ />`, m`<ReturnStatement 'return' />`, m`<ThrowStatement 'throw' />`, m`<ExpressionStatement />`, m`<VariableDeclarationStatement 'var' />`]);
    }
    *EmptyStatement({
      props: {
        allowEmpty = true
