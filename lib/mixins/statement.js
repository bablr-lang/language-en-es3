 ...
 * @generatedfrom ./statement.macro.js#14dd697984e6f507a8b438017d216f9a6cbb223b
  ...
  return class ES3StatementGrammar extends Base {
    ...
    *Statement({
      ...
      yield eat(m`<_Any />`, [[m`<EmptyStatement /;|$/ />`, o({
        allowEmpty
      })], m`<BlockStatement '{' />`, m`<IfStatement 'if' />`, m`<WhileStatement 'while' />`, m`<DoWhileStatement 'do' />`, m`<SwitchStatement 'switch' />`, m`<_LoopStatement 'for' />`, m`<FunctionStatement /function [a-zA-Z$_]/ />`, m`<ReturnStatement 'return' />`, m`<ThrowStatement 'throw' />`, m`<ExpressionStatement />`]);
    }
    *EmptyStatement({
      props: {
        allowEmpty = true
