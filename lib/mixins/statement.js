 ...
 * @generatedfrom ./statement.macro.js#f6e5ff49e21b0987ac254c941d7052ad059c4d27
...
export const mixin = Base => {
  ...
  return class ES3StatementGrammar extends Base {
    ...
    *VariableDeclarationStatement() {
      ...
      yield eat(m`declarations[]: <List />`, o({
    ...
    *Statement({
      ...
      yield eat(m`<Any />`, [[m`<EmptyStatement /;|$/ />`, o({
        allowEmpty
      })], m`<BlockStatement '{' />`, m`<IfStatement 'if' />`, m`<WhileStatement 'while' />`, m`<DoWhileStatement 'do' />`, m`<SwitchStatement 'switch' />`, m`<LoopStatement 'for' />`, m`<FunctionStatement /function [a-zA-Z$_]/ />`, m`<ReturnStatement 'return' />`, m`<ThrowStatement 'throw' />`, m`<ExpressionStatement />`]);
    }
    *EmptyStatement({
      props: {
        allowEmpty = true
    ...
    *IfStatement() {
      ...
      yield eat(m`consequent: <Statement />`, o({
        allowEmpty: false
      }));
