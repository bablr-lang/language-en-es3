...
export const mixin = (Base) => {
  ...
  return class ES3StatementGrammar extends Base {
    static {
      [_initProto] = _applyDecs(
        ...
        [
          ...
          [_ForInStatementDecs, 2, 'ForInStatement'],
    ...
    *[((_ExpressionStatementDecs = [CoveredBy('Statement'), AllowEmpty, Node]),
    ...
    (_ForStatementDecs = [CoveredBy('LoopStatement'), CoveredBy('Statement'), Node]),
    (_ForInStatementDecs = [CoveredBy('LoopStatement'), CoveredBy('Statement'), Node]),
