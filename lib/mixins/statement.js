...
export const mixin = (Base) => {
  let _initProto,
    ...
    _FunctionStatementDecs,
    _ReturnStatementDecs,
    _ThrowStatementDecs,
    _DebuggerStatementDecs,
    _VariableDeclarationStatementDecs,
    _EmptyStatementDecs,
    _BlockStatementDecs,
    _IfStatementDecs,
    _TryCatchStatementDecs,
    _WhileStatementDecs,
    _DoWhileStatementDecs,
    _SwitchStatementDecs,
    _ForStatementDecs,
    _LabeledStatementDecs,
    _BreakStatementDecs,
    _ContinueStatementDecs,
    _PunctuatorDecs;
  return class ES3StatementGrammar extends Base {
    static {
      [_initProto] = _applyDecs(
        this,
        [
          [AllowEmpty, 2, 'StatementList'],
          [_ExpressionStatementDecs, 2, 'ExpressionStatement'],
          [_FunctionStatementDecs, 2, 'FunctionStatement'],
          [_ReturnStatementDecs, 2, 'ReturnStatement'],
          [_ThrowStatementDecs, 2, 'ThrowStatement'],
          [_DebuggerStatementDecs, 2, 'DebuggerStatement'],
          [_VariableDeclarationStatementDecs, 2, 'VariableDeclarationStatement'],
          [Node, 2, 'VariableDeclarator'],
          [AllowEmpty, 2, 'Statement'],
          [_EmptyStatementDecs, 2, 'EmptyStatement'],
          [_BlockStatementDecs, 2, 'BlockStatement'],
          [_IfStatementDecs, 2, 'IfStatement'],
          [_TryCatchStatementDecs, 2, 'TryCatchStatement'],
          [Node, 2, 'CatchClause'],
          [Node, 2, 'FinallyClause'],
          [_WhileStatementDecs, 2, 'WhileStatement'],
          [_DoWhileStatementDecs, 2, 'DoWhileStatement'],
          [_SwitchStatementDecs, 2, 'SwitchStatement'],
          [Node, 2, 'SwitchCase'],
          [_ForStatementDecs, 2, 'ForStatement'],
          [_LabeledStatementDecs, 2, 'LabeledStatement'],
          [_BreakStatementDecs, 2, 'BreakStatement'],
          [_ContinueStatementDecs, 2, 'ContinueStatement'],
    ...
    *[((_ExpressionStatementDecs = [CoveredBy('Statement'), AllowEmpty, Node]),
    (_FunctionStatementDecs = [CoveredBy('Statement'), Node]),
    (_ReturnStatementDecs = [CoveredBy('Statement'), Node]),
    (_ThrowStatementDecs = [CoveredBy('Statement'), Node]),
    (_DebuggerStatementDecs = [CoveredBy('Statement'), Node]),
    (_VariableDeclarationStatementDecs = [CoveredBy('Statement'), Node]),
    (_EmptyStatementDecs = [CoveredBy('Statement'), AllowEmpty, Node]),
    (_BlockStatementDecs = [CoveredBy('Statement'), Node]),
    (_IfStatementDecs = [CoveredBy('Statement'), Node]),
    (_TryCatchStatementDecs = [CoveredBy('Statement'), Node]),
    (_WhileStatementDecs = [CoveredBy('Statement'), Node]),
    (_DoWhileStatementDecs = [CoveredBy('Statement'), Node]),
    (_SwitchStatementDecs = [CoveredBy('Statement'), Node]),
    (_ForStatementDecs = [CoveredBy('Statement'), Node]),
    (_LabeledStatementDecs = [CoveredBy('Statement'), Node]),
    (_BreakStatementDecs = [CoveredBy('Statement'), Node]),
    (_ContinueStatementDecs = [CoveredBy('Statement'), Node]),
    ...
    *TryCatchStatement() {
      ...
      let catch_ = yield eatMatch(
        m`handler: <CatchClause />`,
        o({}),
        o({
          bind: true,
        }),
    ...
    *ForStatement() {
      ...
      if (
        !(yield eatMatch(
          m`init+$: <VariableDeclarationStatement />`,
          o({
            noSemi: true,
          }),
        ))
      ...
      let in_ = yield eatMatch(
        m`inToken: <*Keyword 'in' />`,
        o({}),
        o({
          bind: true,
        }),
