 ...
 * @generatedfrom ./statement.macro.js#7507747a4f419124d358dae146de85a85b46b69b
...
export const mixin = Base => {
  let _initProto, _ExpressionStatementDecs, _FunctionStatementDecs, _ReturnStatementDecs, _ThrowStatementDecs, _VariableDeclarationStatementDecs, _EmptyStatementDecs, _BlockStatementDecs, _IfStatementDecs, _WhileStatementDecs, _DoWhileStatementDecs, _SwitchStatementDecs, _ForStatementDecs, _ForInStatementDecs, _LabeledStatementDecs, _BreakStatementDecs, _ContinueStatementDecs, _PunctuatorDecs;
  return class ES3StatementGrammar extends Base {
    ...
    *[(_ExpressionStatementDecs = [CoveredBy('Statement'), AllowEmpty, Node], _FunctionStatementDecs = [CoveredBy('Statement'), Node], _ReturnStatementDecs = [CoveredBy('Statement'), Node], _ThrowStatementDecs = [CoveredBy('Statement'), Node], _VariableDeclarationStatementDecs = [CoveredBy('Statement'), Node], _EmptyStatementDecs = [CoveredBy('Statement'), AllowEmpty, Node], _BlockStatementDecs = [CoveredBy('Statement'), Node], _IfStatementDecs = [CoveredBy('Statement'), Node], _WhileStatementDecs = [CoveredBy('Statement'), Node], _DoWhileStatementDecs = [CoveredBy('Statement'), Node], _SwitchStatementDecs = [CoveredBy('Statement'), Node], _ForStatementDecs = [CoveredBy('LoopStatement'), CoveredBy('Statement'), Node], _ForInStatementDecs = [CoveredBy('LoopStatement'), CoveredBy('Statement'), Node], _LabeledStatementDecs = [CoveredBy('Statement'), Node], _BreakStatementDecs = [CoveredBy('Statement'), Node], _ContinueStatementDecs = [CoveredBy('Statement'), Node], _PunctuatorDecs = [Node, InjectFrom(productions)], "StatementList")]({
      ctx,
      s
    }) {
    ...
    *VariableDeclarator() {
      ...
      if (yield match(re`/=/s`)) {
        ...
        yield eat(m`init+$: <__Expression />`, o({
          power: 32
        }));
      } else {
    ...
    *Statement({
      ...
      yield eat(m`<_Any />`, [[m`<EmptyStatement /;/ />`, o({
        allowEmpty
      })], m`<BlockStatement '{' />`, m`<IfStatement 'if' />`, m`<WhileStatement 'while' />`, m`<DoWhileStatement 'do' />`, m`<SwitchStatement 'switch' />`, m`<_LoopStatement 'for' />`, m`<FunctionStatement /function [a-zA-Z$_]/ />`, m`<ReturnStatement 'return' />`, m`<ThrowStatement 'throw' />`, m`<ExpressionStatement />`, m`<VariableDeclarationStatement 'var' />`]);
    }
    *EmptyStatement({
      props: {
        allowEmpty = true
