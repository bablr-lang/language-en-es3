...
export const mixin = (Base) =>
  class ES3StatementGrammar extends Base {
    ...
    *Statement({ props: { allowEmpty = true } }) {
      yield eat(
        ...
        [
          ...
          m`<BlockStatement '{' />`,
          m`<IfStatement /if\b/ />`,
          m`<WhileStatement /while\b/ />`,
          m`<DoWhileStatement /do\b/ />`,
          m`<SwitchStatement /switch\b/ />`,
          m`<ForStatement /for\b/ />`,
          m`<FunctionStatement /function\b/ />`,
          m`<TryCatchStatement /try\b/ />`,
          m`<ReturnStatement /return\b/ />`,
          m`<ContinueStatement /continue\b/ />`,
          m`<LabeledStatement />`,
          m`<BreakStatement /break\b/ />`,
          m`<ThrowStatement /throw\b/ />`,
          m`<DebuggerStatement /debugger\b/ />`,
          m`<VariableDeclarationStatement /var\b/ />`,
    ...
    *SwitchCase({ intrinsicValue, ctx }) {
      switch (ctx.sourceTextFor(intrinsicValue.value)) {
        case 'case':
