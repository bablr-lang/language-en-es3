 ...
 * @generatedfrom ./json.macro.js#0f91b25b9d7a7077344189dca3827239a4c7dab2
...
export const mixin = Base => {
  let _initProto, _BooleanDecs, _NullDecs, _ArrayDecs, _ObjectDecs, _StringDecs;
  return class ES3JSONGrammar extends Base {
    static {
      [_initProto] = _applyDecs(this, [[_BooleanDecs, 2, "Boolean"], [_NullDecs, 2, "Null"], [_ArrayDecs, 2, "Array"], [_ObjectDecs, 2, "Object"], [Node, 2, "Property"], [_StringDecs, 2, "String"], [[AllowEmpty, Node], 2, "StringContent"], [Node, 2, "EscapeSequence"], [Node, 2, "EscapeCode"]], [], 0, void 0, Base).e;
    }
    constructor(...args) {
      super(...args);
      _initProto(this);
    }
    *[(_BooleanDecs = [CoveredBy('Expression'), Node], _NullDecs = [CoveredBy('Expression'), Node], _ArrayDecs = [CoveredBy('Expression'), Node], _ObjectDecs = [CoveredBy('Expression'), Node], _StringDecs = [CoveredBy('Language'), Node], "Boolean")]() {
