 ...
 * @generatedfrom ./logic.macro.js#3cc976537088577de6a91e9d27160d7dc9538d9f
...
export const mixin = (Base) => {
  let _initProto,
    _UnaryExpressionDecs,
    _BinaryExpressionDecs,
    _AssignmentExpressionDecs,
    _MemberExpressionDecs,
    _TernaryExpressionDecs,
    _CommaExpressionDecs;
  return class ES3LogicGrammar extends Base {
    static {
      [_initProto] = _applyDecs(
        this,
        [
          [_UnaryExpressionDecs, 2, 'UnaryExpression'],
          [_BinaryExpressionDecs, 2, 'BinaryExpression'],
          [_AssignmentExpressionDecs, 2, 'AssignmentExpression'],
          [_MemberExpressionDecs, 2, 'MemberExpression'],
          [_TernaryExpressionDecs, 2, 'TernaryExpression'],
          [_CommaExpressionDecs, 2, 'CommaExpression'],
        ],
        [],
        0,
        void 0,
    ...
    *[((_UnaryExpressionDecs = [
    ...
    (_CommaExpressionDecs = [UnboundAttributes(['power']), CoveredBy('Expression'), Node]),
